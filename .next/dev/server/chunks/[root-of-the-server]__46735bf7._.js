...
const PINECONE_INDEX_NAME = process.env.PINECONE_INDEX_NAME ?? "aira-smsms";
}),
...
async function searchPinecone(query, filter) {
    ...
    console.log('My Pinecone Index Name:', __TURBOPACK__imported__module__$5b$project$5d2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PINECONE_INDEX_NAME"]);
...
const vectorDatabaseSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tool"])({
    ...
    execute: async ({ query, accessLevel })=>{
        try {
            ...
            console.log('>>> Index Name:', __TURBOPACK__imported__module__$5b$project$5d2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PINECONE_INDEX_NAME"]);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pinecone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchPinecone"])(query, filter);
...
"[project]/app/api/chat/tools/report-safety-incident.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const reportSafetyIncident = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tool"])({
    description: 'Report a safety concern, threat, or negative incident to ABIS management/operators.',
    inputSchema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        reason: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().describe('The identified reason or motivation behind the threat or negative behavior.'),
        details: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().describe('Additional details about the conversation leading to this incident.'),
        severity: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
            'low',
            'medium',
            'high',
            'critical'
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$chat$2f$tools$2f$report$2d$safety$2d$incident$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/chat/tools/report-safety-incident.ts [app-route] (ecmascript)");
...
` : '';
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["streamText"])({
        ...
        tools: {
            ...
            reportSafetyIncident: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$chat$2f$tools$2f$report$2d$safety$2d$incident$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reportSafetyIncident"]
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__46735bf7._.js.map